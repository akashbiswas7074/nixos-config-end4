...
QtObject {
    ...
    function _fetchNextTagCount(): void {
        ...
        root.tagCountProcess.command = ["curl", "-s", "--max-time", "15", "-H", "User-Agent: " + defaultUserAgent, url]
    ...
    function triggerTagSearch(query, preferQuoted) {
        ...
        root.tagSuggestionProcess.command = ["curl", "-s", "--max-time", "15", "-H", "User-Agent: " + defaultUserAgent, url]
    ...
    function _fetchNextTag(): void {
        ...
        root.tagDetailProcess.command = ["curl", "-s", "--max-time", "15", "-H", "User-Agent: " + defaultUserAgent, url]
    ...
    function makeRequest(tags, nsfw, limit, page) {
        ...
        root.searchProcess.command = ["curl", "-s", "--max-time", "20", "-H", "User-Agent: " + defaultUserAgent, url]
