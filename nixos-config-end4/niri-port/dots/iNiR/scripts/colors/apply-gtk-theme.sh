...
generate_kdeglobals() {
    ...
    if [[ -z "$icon_theme" ]]; then
        if [[ -d "$HOME/.local/share/icons/WhiteSur-dark" || -d "/usr/share/icons/WhiteSur-dark" || -d "/run/current-system/sw/share/icons/WhiteSur-dark" || -d "/etc/profiles/per-user/$USER/share/icons/WhiteSur-dark" ]]; then
